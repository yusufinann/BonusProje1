...
namespace BonusProje1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBLNOTLARDataTable : global::System.Data.TypedTableBase<TBLNOTLARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLNOTLARRow AddTBLNOTLARRow(int OGRID, byte SINAV1, byte SINAV2, byte PROJE, decimal ORTALAMA, bool DURUM, string DERSAD) {
            ...
            public string DERSAD {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'TBLNOTLAR\' tablosundaki \'DERSAD\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class TBLOGRENCILERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLOGREN" +
                "CILER.OGRCINSIYET, TBLKULUPLER.KULUPAD\r\nFROM     TBLOGRENCILER INNER JOIN TBLKUL" +
                "UPLER ON TBLOGRENCILER.OGRKULUP=TBLKULUPLER.KULUPID\r\nWHERE TBLOGRENCILER.OGRAD=@" +
                "OGRAD";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3].CommandText = "UPDATE TBLOGRENCILER\r\nSET          OGRAD =@OGRAD , OGRSOYAD =@OGRSOYAD , OGRKULUP" +
                " =@OGRKULUP , OGRCINSIYET =@OGRCINSIYET  WHERE OGRID=@OGRID";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT TBLNOTLAR.NOTID, TBLDERSLER.DERSAD, TBLNOTLAR.OGRID, TBLNOTLAR.SINAV1, TBLNOTLAR.SINAV2, TBLNOTLAR.PROJE, TBLNOTLAR.ORTALAMA, TBLNOTLAR.DURUM
...
SET          OGRID = @OGRID, SINAV1 = @SINAV1, SINAV2 = @SINAV2, PROJE = @PROJE, ORTALAMA = @ORTALAMA, DURUM = @DURUM
FROM     TBLNOTLAR INNER JOIN
                  TBLDERSLER ON TBLNOTLAR.DERSID = TBLDERSLER.DERSID
WHERE  (TBLNOTLAR.NOTID = @NOTID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.TBLNOTLARDataTable NotListele(global::System.Nullable<int> OGRID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((OGRID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(OGRID.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int NotGuncelle(global::System.Nullable<int> OGRID, global::System.Nullable<byte> SINAV1, global::System.Nullable<byte> SINAV2, global::System.Nullable<byte> PROJE, global::System.Nullable<decimal> ORTALAMA, global::System.Nullable<bool> DURUM, int NOTID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((OGRID.HasValue == true)) {
